"""Vanilla baseline for HLE (Humanity's Last Exam) gold subset, no tools, multithreaded, resumable."""
...
SYSTEM_PROMPT = (
    ...
    "Provide only your final answer, wrapped in triple angle brackets like <<<answer>>>."
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Vanilla baseline for HLE (no tools, multithreaded, resumable)")
    ...
    output_path = args.output or os.path.join("results", model_name, "vanilla", "hle_result.json")
