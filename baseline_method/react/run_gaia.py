"""ReAct baseline: reasoning + acting loop."""
...
from baseline_method.react.agent import react_solve
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ReAct baseline for GAIA")
    ...
    output_path = args.output or os.path.join("results", model_name, "react", "gaia_result.json")
