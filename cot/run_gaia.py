"""Chain-of-Thought baseline with tool support: reason step by step with tools."""
...
SYSTEM_PROMPT = (
    ...
    "Think step by step, but use tools only when necessary. "
    "Avoid repeating searches or making redundant calculations. "
    "Once you have the key information, stop and give the final answer."
)
...
def solve(question: str) -> dict:
    """Chain-of-thought tool-augmented question answering."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="CoT baseline for GAIA")
    ...
    output_path = args.output or os.path.join("results", model_name, "cot", "gaia_result.json")
